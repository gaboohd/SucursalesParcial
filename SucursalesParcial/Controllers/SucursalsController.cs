...
namespace SucursalesParcial.Controllers
{
    public class SucursalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Ciudad,Estado,CodigoPostal,Telefono,CorreoElectronico")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Ciudad,Estado,CodigoPostal,Telefono,CorreoElectronico")] Sucursal sucursal)
        {
            if (id != sucursal.Id)
            {
                return NotFound();
